...
|--------|-----------------|------|---------|----|----|-----------|
| `DEMAIS_CUSTAS_ID` | BIGINT | N | - | sim |  | |
| `DESCRICAO` | VARCHAR(90) | N | - |  |  | |
| `VALOR` | BIGINT | N | - |  |  | |
| `TIPO_CENPROT` | VARCHAR(10) | N | - |  |  | |
| `EMOLUMENTO_PERIODO_ID` | BIGINT | N | - |  |  | |
| `TIPO_LANCAMENTO` | VARCHAR(3) | N | - |  |  | |
...
| Nome | Tipo | Colunas |
|------|------|---------|
| `P_DEMAIS_CUSTAS_PK` | PRIMARY KEY | DEMAIS_CUSTAS_ID |
| _(nenhuma)_ | - | - |
| _(nenhuma)_ | - | - |
