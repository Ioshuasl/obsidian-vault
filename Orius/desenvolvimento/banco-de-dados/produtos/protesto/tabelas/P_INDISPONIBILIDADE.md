...
|--------|-----------------|------|---------|----|----|-----------|
| `INDISPONIBILIDADE_ID` | BIGINT | N | - | sim |  | |
| `NUMERO_OFICIO` | VARCHAR(15) | N | - |  |  | |
| `DATA_OFICIO` | TIMESTAMP | N | - |  |  | |
| `OBSERVACAO` | VARCHAR(90) | N | - |  |  | |

## Chaves e indices

| Nome | Tipo | Colunas |
|------|------|---------|
| `P_INDISPONIBILIDADE_PK` | PRIMARY KEY | INDISPONIBILIDADE_ID |
| _(nenhuma)_ | - | - |
| _(nenhuma)_ | - | - |
