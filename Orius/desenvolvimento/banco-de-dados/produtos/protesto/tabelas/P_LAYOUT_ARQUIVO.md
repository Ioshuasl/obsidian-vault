...
|--------|-----------------|------|---------|----|----|-----------|
| `LAYOUT_ARQUIVO_ID` | BIGINT | N | - | sim |  | |
| `TIPO` | BIGINT | N | - |  |  | |
...
| Nome | Tipo | Colunas |
|------|------|---------|
| `P_LAYOUT_ARQUIVO_PK` | PRIMARY KEY | LAYOUT_ARQUIVO_ID |
| `P_LAYOUT_ARQUIVO_LAYOUT_FK` | FOREIGN KEY | LAYOUT_ID -> `P_LAYOUT(LAYOUT_ID)` |
| _(nenhuma)_ | - | - |
