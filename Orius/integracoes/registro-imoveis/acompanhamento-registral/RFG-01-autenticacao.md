...
- Próximos passos de integração: [[Orius/integracoes/registro-imoveis/acompanhamento-registral/00-indice#Acompanhamento registral (protocolo)]]
...
| Data | Alteração |
|------|-----------|
| 2026-06-01 | Extraído do manual v2.2; primeira nota da série acompanhamento-registral |
