...
> **Alternativa sem anexo:** [[Orius/integracoes/registro-imoveis/acompanhamento-registral/RFP-01-envio-online]]
...
Diferenças principais em relação ao [[Orius/integracoes/registro-imoveis/acompanhamento-registral/RFP-01-envio-online|RFP-01 (online)]]:
...
> Detalhes de `cobranca`, `apresentante`, `status` e domínios: mesma estrutura documentada em [[Orius/integracoes/registro-imoveis/acompanhamento-registral/RFP-01-envio-online#Request|RFP-01 — Request]].
...
Padrão RIB: `codigo`, `descricao`, `campos` — [[Orius/integracoes/registro-imoveis/acompanhamento-registral/visao-geral#Formato das respostas]].
