...
**Uma frase:** cadastrar **na hora** um acompanhamento registral (protocolo) na plataforma RIB, com validação imediata — **sem anexos** (anexos exigem [[Orius/integracoes/registro-imoveis/api-registro-imoveis/RFP-02-envio-lote|RFP-02 — lote]]).
...
Ver [[Orius/integracoes/registro-imoveis/api-registro-imoveis/visao-geral#Formato das respostas]].
...
Fluxo completo (diagramas oficiais): [[FFP-01-fluxo-envio-protocolo]] · [[FFP-02-fluxo-processamento-protocolo]].
...
| Código | Relação |
|--------|---------|
| [[Orius/integracoes/registro-imoveis/api-registro-imoveis/RFG-01-autenticacao]] | Token obrigatório |
