...
tags: [orius, imoveis, rib, api, api-registro-imoveis, TEMPLATE]
codigo: XXX-00
manual: v2.2
status: rascunho
---
...
- [ ] Token JWT ([[Orius/integracoes/registro-imoveis/api-registro-imoveis/RFG-01-autenticacao|RFG-01]])
- [ ] Credenciais em [[env]]
...
Padrão RIB: `codigo`, `descricao`, `campos` — ver [[Orius/integracoes/registro-imoveis/api-registro-imoveis/visao-geral#Formato das respostas]].
