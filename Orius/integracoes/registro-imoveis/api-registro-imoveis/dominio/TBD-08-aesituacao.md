...
| Contexto | Campo |
|----------|-------|
| [[RAE-01-listagem-resposta-exigencia]] | Query `status` (filtro); item `status` + `statusDescricao` |
| [[RAE-02-detalhes-resposta-exigencia]] | Situação no detalhe |
| [[RAE-03-cadastro-interacao]] | Pode alterar situação após nova interação (reconsultar detalhe) |
