...
produto: imoveis
central: onr
tags: [orius, imoveis, onr, mapa, sig-ri, poligonos, shapefile, api]
status: revisado
criado: 2026-06-01
fonte: cursor
---
...
Este texto explica, em linguagem simples, o que são os principais conceitos do ecossistema geográfico do Registro de Imóveis e **como a API de envio de polígonos** se encaixa nesse mundo.

**Manuais ONR (PDF → markdown no repositório de automação):**

- Manual Técnico Operacional do Mapa (Provimento CNJ nº 195/2025): `c:\Users\kenio\automacoes e testes\mapa-onr\manual-tecnico-mapa-v12.md`
- Manual API para Envio dos Polígonos: `c:\Users\kenio\automacoes e testes\mapa-onr\manual-api-envio-poligonos.md`

**Cópia editável deste guia no repo:** `c:\Users\kenio\automacoes e testes\mapa-onr\guia-api-poligonos-para-leigos.md`
...
| Repo `automacoes e testes/mapa-onr/` | `manual-api-envio-poligonos.md` | Endpoints, JSON, status, token |
| Repo `automacoes e testes/mapa-onr/` | `guia-api-poligonos-para-leigos.md` | Esta nota (espelho) |

## Ver também

- [[Orius/integracoes/registro-imoveis/00-indice]] · [[Orius/integracoes/centrais/onr]]
