...
produto: imoveis
central: onr
tags: [orius, imoveis, onr, mapa, estatisticas, doi, doiweb, api]
status: revisado
criado: 2026-06-01
fonte: cursor
---
...
**Referências no vault:** [[Orius/integracoes/registro-imoveis/onr-mapa-estatisticas-referencia-api|referência resumida de endpoints]] · PDF convertido no repo: `automacoes e testes/mapa-onr/documentacao-api-mapa-estatisticas.md`

> **Não confundir** com a [[Orius/integracoes/registro-imoveis/onr-mapa-api-poligonos|API de polígonos (SIG-RI)]], que usa outra base URL, outro tipo de chave e shapefile.

**Cópia editável no repo:** `c:\Users\kenio\automacoes e testes\mapa-onr\guia-api-mapa-estatisticas-para-leigos.md`
...
> Para implementação, use o exemplo integral em [[Orius/integracoes/registro-imoveis/onr-mapa-estatisticas-referencia-api]] ou no PDF convertido no repositório `mapa-onr/`.
...
Para implementação rigorosa, consulte as tabelas do PDF oficial (`mapa-onr/documentacao-api-mapa-estatisticas.md` no repositório de automação), seção 6.
...
- **Postman:** [[Orius/integracoes/registro-imoveis/onr-mapa-estatisticas.postman-collection.json]] (importar no Postman/Insomnia)

---

## Documentos relacionados (vault)

| Nota | Conteúdo |
|------|----------|
| [[Orius/integracoes/registro-imoveis/onr-mapa-estatisticas]] | Hub desta integração |
| [[Orius/integracoes/registro-imoveis/onr-mapa-estatisticas-referencia-api]] | Endpoints e exemplos JSON (referência rápida) |
| [[Orius/integracoes/registro-imoveis/onr-mapa-api-poligonos]] | API de polígonos (SIG-RI) |
