...
central: onr
protocolo: soap
operacao: LoginUsuarioCertificado
tags: [orius, onr, n8n, proxy, LoginUsuarioCertificado]
fonte_repositorio: C:/Users/kenio/soap-ui test/scripts/login/Auth WebService ONR.md
status: revisado
plane_work_item_id: 2c4e82e2-abca-45f5-b535-ab030f199d39
plane_sequence_id: 2
plane_key: AUTONR-2
plane_url: http://192.168.1.100:8090/saas/projects/1c5d97b3-edfc-49e1-b0ba-da037b09bb84/issues/2
plane_automation_status: done
---> **Método SOAP:** [[Orius/integracoes/registro-imoveis/onr/webservice-wsoficio/metodos/login/LoginUsuarioCertificado]]
> **Scripts locais:** `C:\Users\kenio\soap-ui test\scripts\login\`
...
|-------|-------|
| Card | **AUTONR-2** |
| Work item ID | `2c4e82e2-abca-45f5-b535-ab030f199d39` |
| URL | http://192.168.1.100:8090/saas/projects/1c5d97b3-edfc-49e1-b0ba-da037b09bb84/issues/2 |
| Automação | `done` |
...
- **Documentação do método:** [[Orius/integracoes/registro-imoveis/onr/webservice-wsoficio/metodos/login/LoginUsuarioCertificado]]
...
Os tokens retornados alimentam o cálculo de `Hash` das demais operações SOAP — ver [[Orius/integracoes/registro-imoveis/onr/webservice-wsoficio/hash]].
...
Códigos de erro comuns: ver tabela em [`LoginUsuarioCertificado.md`]].
...
- [[Orius/integracoes/registro-imoveis/onr/webservice-wsoficio/metodos/login/LoginUsuarioCertificado]] — spec do método
- [[Orius/integracoes/registro-imoveis/onr/webservice-wsoficio/hash]] — uso dos tokens e cálculo do Hash
