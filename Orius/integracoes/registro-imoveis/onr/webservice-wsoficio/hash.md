...
central: onr
protocolo: soap
tags: [orius, onr, hash, autenticacao]
fonte_repositorio: C:\Users\kenio\soap-ui test\webservice-onr\hash.md
---

> **RepositÃ³rio local (scripts/cÃ³digo):** `C:\Users\kenio\soap-ui test`
...
Fonte: capítulo **2 — Requisitos de Segurança** em _especificação no repositório local_.
...
- _especificação no repositório local_ — § 2 e § 3.1
