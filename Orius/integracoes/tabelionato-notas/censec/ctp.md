...
central: censec
modulo: ctp
tags: [orius, notas, censec, ctp, prefeitura, itbi]
status: revisado
...
> **CENSEC:** [[Orius/integracoes/tabelionato-notas/censec/visao-geral-e-api|Visão geral]] · Ver também [[Orius/integracoes/tabelionato-notas/doi|DOI]]

**Validação e domínios:** [[Orius/integracoes/tabelionato-notas/censec/regras-validacao/ctp]] · [[Orius/integracoes/tabelionato-notas/censec/tabelas-dominio/ctp]] · **n8n:** [[Orius/integracoes/tabelionato-notas/censec/automacao/n8n-upload-json-gateway]] (bloco `declaracoes`)

---

# CTP — Comunicação de Transações às Prefeituras
