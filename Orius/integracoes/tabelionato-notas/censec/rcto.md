...
central: censec
modulo: rcto
tags: [orius, notas, censec, rcto, testamento]
status: revisado
...
**Payload:** bloco `testamentos` no JSON único. **n8n:** o gateway atual **não valida** RCTO — ver [[Orius/integracoes/tabelionato-notas/censec/automacao/n8n-upload-json-gateway#Validação local (por central)]].

---

# RCTO — Registro Central de Testamentos
